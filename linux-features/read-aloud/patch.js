...
function applyLinuxDesktopSettingsPatch(source) {
  ...
  if (!patched.includes("class LinuxReadAloudSettings extends React.Component")) {
    patched = patched.replace(
